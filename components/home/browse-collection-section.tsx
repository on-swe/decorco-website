    ...
    <section className="bg-accent-light py-16 md:py-24 text-text-dark text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10">
        <ScrollReveal delay={0.2}>
          <h2 className="text-4xl md:text-5xl font-serif mb-6">Browse Our Collection</h2>
        </ScrollReveal>
        <ScrollReveal delay={0.4}>
          <p className="text-lg mb-8">
            Discover a curated selection of our finest interior design projects and furniture pieces. Find inspiration
            for your next home transformation.
          </p>
        </ScrollReveal>
